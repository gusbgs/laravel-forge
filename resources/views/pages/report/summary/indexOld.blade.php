      ...
      <div class="card card-custom card-stretch">
        ...
        <div class="card-header py-3">
          ...
          <div class="card-toolbar">
            <!--begin::Button-->
            @if ($date == true && Auth::user()->role->reports_summary_print == 1)
              <a href="/report/summary/export?change={{ $change }}&type={{ $type }}&date={{ $date }}" class="btn btn-success font-weight-bolder mr-2 mb-2">
            ...
            <div class="form-group">
              ...
              <select name="type" class="form-control" required>
                @if($type != null)
                  ...
                  @else
                    <option value="rekapitulasi_laporan_bulanan_hijau" hidden>Rekapitulasi Laporan Bulanan (Hijau)</option>
                  @endif
                @endif
                @if (Auth::user()->role->reports_summary_all == 1)
                ...
                <option value="rekapitulasi_laporan_bulanan_hijau">Rekapitulasi Laporan Bulanan (Hijau)</option>
              </select>
            </div>
            
            <div class="form-group">
              <label for="">Waktu</label>
              <input type="text" name="date" value="{{ $date }}" id="kt_datepicker_month" class="form-control" required placeholder="Pilih Waktu" autocomplete="off">
            </div>
