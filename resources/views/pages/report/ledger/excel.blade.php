<table>
    <thead>
        ...
        <tr>
            ...
            @endphp
            <th colspan="6" style="text-align: center; border: 1px solid black;"> {{ $total ?? '0' }} </th>
        </tr>
        ...
        <tr>
            ...
            <th colspan="3" style="text-align: center; border: 1px solid black;"> {{ $last_year ?? '0' }} </th>
            <th colspan="3" style="text-align: center; border: 1px solid black;"> {{ $this_year ?? '0' }} </th>
        </tr>
        ...
        <tr class="bg-primary">
            ...
            <th colspan="2" style="text-align: center; background-color: #3569fe; color:white; border: 1px solid black;">Jenis Pajak</th>
    ...
    <tbody>
        ...
        <tr>
            ...
            <td colspan="2" style="text-align: left; border: 1px solid black;">{{ $item->account->name }}</td>
